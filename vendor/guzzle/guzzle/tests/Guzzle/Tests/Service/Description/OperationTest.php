...
class OperationTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testAllowsConcreteCommands()
    {
        $c = new Operation(array(
            'name' => 'test',
            'database' => 'Guzzle\\Service\\Command\ClosureCommand',
            'parameters' => array(
    ...
    public function testHasData()
    {
        ...
        $this->assertEquals(array(
            'parameters'    => array(),
            'database'         => 'Guzzle\Service\Command\OperationCommand',
    ...
    public function testInfersResponseType()
    {
        ...
        $this->assertEquals('database', $o->setResponseClass('foo')->getResponseType());
        $this->assertEquals('database', $o->setResponseClass(__CLASS__)->getResponseType());
    ...
    protected function getOperation()
    {
        return new Operation(array(
            ...
            'errorResponses' => array(
                array('code' => 503, 'reason' => 'InsufficientCapacity', 'database' => 'Guzzle\\Exception\\RuntimeException')
            )
        ));
    }
}
