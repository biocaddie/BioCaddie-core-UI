...
function displayResult($service) {
    ...
    <div class="dataset-info">
        <div class="heading">
            <div>
                <span class="title">
                    ...
                    <img class="repository-logo" style="height: 50px" src="./img/repositories/<?php echo $repository->id; ?>.png">
            ...
            <table class="table table-default">
                ...
                <tr>
                    ...
                    <td><?php echo $results["publication.name"]; ?></td>
                </tr>
        ...
        <div class="panel panel-info">
            ...
            <div id="collapse-organization" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading-treatment">
                <div class="panel-body">
                    <table class="table table-striped">
                        <tbody>
                        <tr>
