    ...
    <div class="pull-right" style="margin-top: 8px">
        ...
        <div class="dropdown" style="display: inline-block">
            ...
            <ul class="dropdown-menu">
                <li><a href="<?php echo $searchBuilder->getUrlBySort('relevance') ?>" title="Sort based on relevance to the search keyword.">Relevance</a></li>
                <li><a href="<?php echo $searchBuilder->getUrlBySort('date') ?>" title="Order By Article Date.">Date</a></li>
                <?php if ($searchBuilder->getCurrentRepository() == '0002' || $searchBuilder->getCurrentRepository() == '0003'): ?>
                    <li><a href="<?php echo $searchBuilder->getUrlBySort('citation') ?>" title="Order By Number of Citations.">Citation</a></li>
                <?php else: ?>
