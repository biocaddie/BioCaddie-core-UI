...
class NeurovaultatlasesRepository extends RepositoryBase {

    public $repoShowName = 'NeuroVault:Atlases';
    public $wholeName = 'NeuroVault&nbsp;Atlases';
    public $id = '0034';
   ...
   // public $searchFields = ['dataset.ID','dataset.creators','dataset.title','dataset.description','dataset.types','taxonomicInformation.name','dataType.method'];
    ...
    public $index = 'neurovaultatlases';
    public $type = 'dataset';
    //search page
