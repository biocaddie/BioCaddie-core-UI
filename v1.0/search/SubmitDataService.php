...
function get_repository_showing_label_new()
{
    $showing_label = [
        "submitter_name" => "Submitter's Name",
        "submitter_email" => "Submitter Email",
        ...
        "in_biosharing"=>'Is the repository listed on biosharing.org?',
...
function get_repository_ids_new(){
    $ids = [
        "submitter_name",
        "submitter_email",
        "submitter_organization",
...
function submit_repository_new($dbconn, $result)
{
