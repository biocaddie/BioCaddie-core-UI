...
function partialSearchPanel($service) {
    $query = $service->getQueryString();
    $repo_status = 'unchecked';
    $data_status = 'checked';

    ?>
    <div class="jumbotron search-block-2" style="line-height: 12px;">
        <form action='search.php' method='get' autocomplete='off'>
            <div class="input-group">

                <input value="<?php echo $query ?>" type="text" class="form-control" placeholder="Search for data through BioCADDIE" name='query' id='query'>
