...
interface ClientInterface extends HttpClientInterface, FromConfigInterface
{
     ...
     * command database exists matching the name supplied. If neither are found, an InvalidArgumentException is thrown.
     *
     ...
     *
     * @param string|CommandInterface $command         Command database or command name.
