...
class ServiceBuilder extends AbstractHasDispatcher implements ServiceBuilderInterface, \ArrayAccess, \Serializable
{
     ...
     *     - database: Client database to instantiate using a factory method
    ...
    public function get($name, $throwAway = false)
    {
        ...
        $client = $builder['database']::factory($config);
    ...
    {
        if (is_array($service) && isset($service['database']) && isset($service['params'])) {
