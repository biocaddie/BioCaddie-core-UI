//d3.csv("writewords.csv",function(error, data)
    var wordCloud = function(resultFinal){
    data = resultFinal;
    var fill = d3.scale.category20();
    var querystring = document.location.href;
    var start = querystring.indexOf("query=");
    var end = querystring.indexOf("\&",start);
    var beforestring = querystring.substring(0,end);
    var behindstring = querystring.substring(end);
    ...
    function draw(words) {
        d3.select("body").select("#word-cloud").select("#svg-key")
            ...
            .attr("xlink:href",function(d){
                return beforestring+"+"+d.text+behindstring;
            })
            .text(function(d) { return d.text; })
