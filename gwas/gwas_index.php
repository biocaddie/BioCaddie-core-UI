				...
				<div class="col-lg-12">
					<table>
						<tr><td>
							...
							<p><font size="2">&nbsp &nbsp&nbsp  Search examples(breast cancer, Alzheimer's disease, etc)</font></p></td>
							<td>&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp</td>
							<td>
								<input type="text" class="form-control" placeholder="Search by platforms" name='query2'>
								<p><font size="2">&nbsp &nbsp&nbsp   Search examples(Illumina,Affymetrix, etc)</font></p></td></tr>
								<tr>
									<td>
