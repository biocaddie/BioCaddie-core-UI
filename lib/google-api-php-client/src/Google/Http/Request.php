...
class Google_Http_Request
{
   ...
   * used by the OAuth signing database to calculate the base string
   ...
   * url used by the OAuth signing database to calculate the signature
  ...
  /**
   * Set the database the response to this request should expect.
   *
   * @param $class string the database name
   */
  ...
  /**
   * Retrieve the expected database the response should expect.
   ...
   * cache key unique per authenticated database, else use the plain request url
