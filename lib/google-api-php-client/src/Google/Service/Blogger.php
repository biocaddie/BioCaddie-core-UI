...
class Google_Service_Blogger_BlogUserInfos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one blog and database info pair by blogId and userId. (blogUserInfos.get)
   *
   * @param string $userId ID of the database whose blogs are to be fetched. Either
   * the word 'self' (sans quote marks) or the database's profile identifier.
...
class Google_Service_Blogger_Blogs_Resource extends Google_Service_Resource
{
   ...
   * per-database information instead of just blogs.
   ...
   * e.g. AUTHOR will return blogs where the database has author level access. If no
...
class Google_Service_Blogger_PostUserInfos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one post and database info pair, by post ID and database ID. The post database info
   * contains per-database information about the post, such as access rights, specific
   * to the database. (postUserInfos.get)
   *
   * @param string $userId ID of the database for the per-database information to be
   * fetched. Either the word 'self' (sans quote marks) or the database's profile
   * identifier.
   * @param string $blogId The ID of the blog.
  ...
  /**
   * Retrieves a list of post and post database info pairs, possibly filtered. The
   * post database info contains per-database information about the post, such as access
   * rights, specific to the database. (postUserInfos.listPostUserInfos)
   *
   * @param string $userId ID of the database for the per-database information to be
   * fetched. Either the word 'self' (sans quote marks) or the database's profile
   * identifier.
...
class Google_Service_Blogger_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one database by ID. (users.get)
   *
   * @param string $userId The ID of the database to get.
   * @param array $optParams Optional parameters.
