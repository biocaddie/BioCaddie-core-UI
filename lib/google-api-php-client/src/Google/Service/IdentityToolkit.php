...
class Google_Service_IdentityToolkit_Relyingparty_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates the URI used by the IdP to authenticate the database.
  ...
  /**
   * Delete database account. (relyingparty.deleteAccount)
   *
  ...
  /**
   * Batch download database accounts. (relyingparty.downloadAccount)
   *
  ...
  /**
   * Get a code for database action confirmation.
  ...
  /**
   * Reset password for a database. (relyingparty.resetPassword)
   *
  ...
  /**
   * Set account info for a database. (relyingparty.setAccountInfo)
   *
  ...
  /**
   * Batch upload existing database accounts. (relyingparty.uploadAccount)
   *
  ...
  /**
   * Verifies the database entered password. (relyingparty.verifyPassword)
   *
