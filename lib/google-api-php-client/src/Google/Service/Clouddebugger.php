...
class Google_Service_Clouddebugger_DebuggerDebuggees_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all the debuggees that the database can set breakpoints to.
...
class Google_Service_Clouddebugger_DebuggerDebuggeesBreakpoints_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all breakpoints of the debuggee that the database has access to.
   ...
   * list of breakpoints set by any database, otherwise only breakpoints set by the
   * caller.
