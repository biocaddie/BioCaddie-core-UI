...
class Google_Service_Books_Bookshelves_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves metadata for a specific bookshelf for the specified database.
   * (bookshelves.get)
   *
   * @param string $userId ID of database for whom to retrieve bookshelves.
  ...
  /**
   * Retrieves a list of public bookshelves for the specified database.
...
class Google_Service_Books_BookshelvesVolumes_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves volumes in a specific bookshelf for the specified database.
   * (volumes.listBookshelvesVolumes)
   *
   * @param string $userId ID of database for whom to retrieve bookshelf volumes.
...
class Google_Service_Books_Myconfig_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets the current settings for the database. (myconfig.getUserSettings)
   *
   * @param array $optParams Optional parameters.
  ...
  /**
   * Sets the settings for the database. If a sub-object is specified, it will
...
class Google_Service_Books_MylibraryBookshelves_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a list of bookshelves belonging to the authenticated database.
...
class Google_Service_Books_Promooffer_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a list of promo offers available to the database (promooffer.get)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string product device product
...
class Google_Service_Books_Volumes_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string projection Restrict information returned to a set of
   * selected fields.
   * @opt_param string libraryRestrict Restrict search to this database's library.
...
class Google_Service_Books_VolumesMybooks_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string processingState The processing state of the database uploaded
...
class Google_Service_Books_VolumesRecommended_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return a list of recommended books for the current database.
  ...
  /**
   * Rate a recommended book for the current database. (recommended.rate)
   *
...
class Google_Service_Books_VolumesUseruploaded_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return a list of books uploaded by the current database.
