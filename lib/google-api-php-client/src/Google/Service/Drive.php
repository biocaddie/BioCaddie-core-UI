...
class Google_Service_Drive_About_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets the information about the current database along with Drive API settings
   * (about.get)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool includeSubscribed When calculating the number of remaining
   * change IDs, whether to include public files the database has opened and shared
   * files. When set to false, this counts only change IDs for owned files and any
   * shared or public files that the database has explicitly added to a folder they
   * own.
...
class Google_Service_Drive_Apps_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists a database's installed apps. (apps.listApps)
   *
   * @param array $optParams Optional parameters.
   *
...
class Google_Service_Drive_Changes_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the changes for a database. (changes.listChanges)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool includeSubscribed Whether to include public files the database
   * has opened and shared files. When set to false, the list only includes owned
   * files plus any shared or public files the database has explicitly added to a
   * folder they own.
  ...
  /**
   * Subscribe to changes for a database. (changes.watch)
   *
...
class Google_Service_Drive_Files_Resource extends Google_Service_Resource
{
   ...
   * authenticated database must own the file. (files.delete)
   *
  ...
  /**
   * Permanently deletes all of the database's trashed files. (files.emptyTrash)
   *
   * @param array $optParams Optional parameters.
   */
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool acknowledgeAbuse Whether the database is acknowledging the risk
  ...
  /**
   * Lists the database's files. (files.listFiles)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string orderBy A comma-separated list of sort keys. Valid keys are
  ...
  /**
   * Moves a file to the trash. The currently authenticated database must own the
   * file. (files.trash)
   *
