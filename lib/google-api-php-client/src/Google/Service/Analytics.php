...
class Google_Service_Analytics extends Google_Service
{
  ...
  /** View Google Analytics database permissions. */
...
class Google_Service_Analytics_ManagementAccountSummaries_Resource extends Google_Service_Resource
{
   ...
   * accounts/properties/profiles) to which the database has access.
...
class Google_Service_Analytics_ManagementAccountUserLinks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes a database from the given account. (accountUserLinks.delete)
   *
   * @param string $accountId Account ID to delete the database link for.
   * @param string $linkId Link ID to delete the database link for.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Adds a new database to the given account. (accountUserLinks.insert)
   *
   * @param string $accountId Account ID to create the database link for.
  ...
  /**
   * Lists account-database links for a given account.
   * (accountUserLinks.listManagementAccountUserLinks)
   *
   * @param string $accountId Account ID to retrieve the database links for.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int max-results The maximum number of account-database links to
   * include in this response.
   * @opt_param int start-index An index of the first account-database link to
  ...
  /**
   * Updates permissions for an existing database on the given account.
   * (accountUserLinks.update)
   *
   * @param string $accountId Account ID to update the account-database link for.
   * @param string $linkId Link ID to update the account-database link for.
   * @param Google_EntityUserLink $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Analytics_EntityUserLink
   */
...
class Google_Service_Analytics_ManagementAccounts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all accounts to which the database has access.
...
class Google_Service_Analytics_ManagementCustomDataSources_Resource extends Google_Service_Resource
{
  ...
  /**
   * List custom data sources to which the database has access.
...
class Google_Service_Analytics_ManagementCustomDimensions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Get a custom dimension to which the database has access. (customDimensions.get)
   *
  ...
  /**
   * Lists custom dimensions to which the database has access.
...
class Google_Service_Analytics_ManagementCustomMetrics_Resource extends Google_Service_Resource
{
  ...
  /**
   * Get a custom metric to which the database has access. (customMetrics.get)
   *
  ...
  /**
   * Lists custom metrics to which the database has access.
...
class Google_Service_Analytics_ManagementExperiments_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns an experiment to which the database has access. (experiments.get)
   *
  ...
  /**
   * Lists experiments to which the database has access.
...
class Google_Service_Analytics_ManagementFilters_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a filters to which the database has access. (filters.get)
   *
...
class Google_Service_Analytics_ManagementGoals_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets a goal to which the database has access. (goals.get)
   *
  ...
  /**
   * Lists goals to which the database has access. (goals.listManagementGoals)
   *
   * @param string $accountId Account ID to retrieve goals for. Can either be a
   * specific account ID or '~all', which refers to all the accounts that database has
   * access to.
   ...
   * properties that database has access to.
   ...
   * (profiles) that database has access to.
   * @param array $optParams Optional parameters.
   *
...
class Google_Service_Analytics_ManagementProfileFilterLinks_Resource extends Google_Service_Resource
{
   ...
   * web properties that database has access to.
...
class Google_Service_Analytics_ManagementProfileUserLinks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes a database from the given view (profile). (profileUserLinks.delete)
   *
   * @param string $accountId Account ID to delete the database link for.
   * @param string $webPropertyId Web Property ID to delete the database link for.
   * @param string $profileId View (Profile) ID to delete the database link for.
   * @param string $linkId Link ID to delete the database link for.
   * @param array $optParams Optional parameters.
   */
  public function delete($accountId, $webPropertyId, $profileId, $linkId, $optParams = array())
  ...
  /**
   * Adds a new database to the given view (profile). (profileUserLinks.insert)
   *
   * @param string $accountId Account ID to create the database link for.
   * @param string $webPropertyId Web Property ID to create the database link for.
   * @param string $profileId View (Profile) ID to create the database link for.
   * @param Google_EntityUserLink $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Analytics_EntityUserLink
   */
  ...
  /**
   * Lists profile-database links for a given view (profile).
   ...
   * to all the web properties that database has access to.
   * @param string $profileId View (Profile) ID to retrieve the profile-database links
   * for. Can either be a specific profile ID or '~all', which refers to all the
   * profiles that database has access to.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int max-results The maximum number of profile-database links to
   * include in this response.
   * @opt_param int start-index An index of the first profile-database link to
   * retrieve. Use this parameter as a pagination mechanism along with the max-
   * results parameter.
   * @return Google_Service_Analytics_EntityUserLinks
   */
  ...
  /**
   * Updates permissions for an existing database on the given view (profile).
   * (profileUserLinks.update)
   *
   * @param string $accountId Account ID to update the database link for.
   * @param string $webPropertyId Web Property ID to update the database link for.
   * @param string $profileId View (Profile ID) to update the database link for.
   * @param string $linkId Link ID to update the database link for.
   * @param Google_EntityUserLink $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Analytics_EntityUserLink
   */
...
class Google_Service_Analytics_ManagementProfiles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets a view (profile) to which the database has access. (profiles.get)
   *
   * @param string $accountId Account ID to retrieve the goal for.
   * @param string $webPropertyId Web property ID to retrieve the goal for.
   * @param string $profileId View (Profile) ID to retrieve the goal for.
  ...
  /**
   * Lists views (profiles) to which the database has access.
   ...
   * to which the database has access.
   ...
   * all the web properties to which the database has access.
   * @param array $optParams Optional parameters.
   *
...
class Google_Service_Analytics_ManagementSegments_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists segments to which the database has access.
...
class Google_Service_Analytics_ManagementUnsampledReports_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists unsampled reports to which the database has access.
...
class Google_Service_Analytics_ManagementUploads_Resource extends Google_Service_Resource
{
  ...
  /**
   * List uploads to which the database has access. (uploads.get)
   *
  ...
  /**
   * List uploads to which the database has access. (uploads.listManagementUploads)
   *
...
class Google_Service_Analytics_ManagementWebPropertyAdWordsLinks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a web property-AdWords link to which the database has access.
...
class Google_Service_Analytics_ManagementWebproperties_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets a web property to which the database has access. (webproperties.get)
   *
...
class Google_Service_Analytics_ManagementWebpropertyUserLinks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes a database from the given web property. (webpropertyUserLinks.delete)
   *
   * @param string $accountId Account ID to delete the database link for.
   * @param string $webPropertyId Web Property ID to delete the database link for.
   * @param string $linkId Link ID to delete the database link for.
  ...
  /**
   * Adds a new database to the given web property. (webpropertyUserLinks.insert)
   *
   * @param string $accountId Account ID to create the database link for.
   * @param string $webPropertyId Web Property ID to create the database link for.
   * @param Google_EntityUserLink $postBody
  ...
  /**
   * Lists webProperty-database links for a given web property.
   ...
   * @param string $webPropertyId Web Property ID for the webProperty-database links
   * to retrieve. Can either be a specific web property ID or '~all', which refers
   * to all the web properties that database has access to.
   * @param array $optParams Optional parameters.
   *
   * @opt_param int max-results The maximum number of webProperty-database Links to
   * include in this response.
   * @opt_param int start-index An index of the first webProperty-database link to
   * retrieve. Use this parameter as a pagination mechanism along with the max-
   * results parameter.
   * @return Google_Service_Analytics_EntityUserLinks
   */
  ...
  /**
   * Updates permissions for an existing database on the given web property.
   * (webpropertyUserLinks.update)
   *
   * @param string $accountId Account ID to update the account-database link for.
   * @param string $webPropertyId Web property ID to update the account-database link
   * for.
   * @param string $linkId Link ID to update the account-database link for.
   * @param Google_EntityUserLink $postBody
   * @param array $optParams Optional parameters.
