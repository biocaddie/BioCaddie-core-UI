...
class Google_Service_Appsactivity_Activities_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a list of activities visible to the current logged in database. Visible
   * activities are determined by the visiblity settings of the object that was
   * acted on, e.g. Drive files a database can see. An activity is a record of past
   ...
   * @opt_param string userId Indicates the database to return activity for. Use the
   * special value me to indicate the currently authenticated database.
