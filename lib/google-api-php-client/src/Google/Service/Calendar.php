...
class Google_Service_Calendar_Acl_Resource extends Google_Service_Resource
{
   ...
   * the currently logged in database, use the "primary" keyword.
...
class Google_Service_Calendar_CalendarList_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes an entry on the database's calendar list. (calendarList.delete)
   *
   * @param string $calendarId Calendar identifier. To retrieve calendar IDs call
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in database, use the "primary" keyword.
  ...
  /**
   * Returns an entry on the database's calendar list. (calendarList.get)
   *
   * @param string $calendarId Calendar identifier. To retrieve calendar IDs call
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in database, use the "primary" keyword.
  ...
  /**
   * Adds an entry to the database's calendar list. (calendarList.insert)
   *
  ...
  /**
   * Returns entries on the database's calendar list. (calendarList.listCalendarList)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string syncToken Token obtained from the nextSyncToken field
   ...
   * @opt_param string minAccessRole The minimum access role for the database in the
  ...
  /**
   * Updates an entry on the database's calendar list. This method supports patch
  ...
  /**
   * Updates an entry on the database's calendar list. (calendarList.update)
   *
   * @param string $calendarId Calendar identifier. To retrieve calendar IDs call
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in database, use the "primary" keyword.
...
class Google_Service_Calendar_Settings_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a single database setting. (settings.get)
   *
   * @param string $setting The id of the database setting.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Returns all database settings for the authenticated database. (settings.listSettings)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken Token specifying which result page to return.
