...
class Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends Google_Service_Resource
{
   ...
   * identifies the content owner that the database is acting on behalf of.
...
class Google_Service_YouTubeAnalytics_Groups_Resource extends Google_Service_Resource
{
   ...
   * example, you can retrieve all groups that the authenticated database owns, or you
   ...
   * to only return groups owned by the authenticated database.
...
class Google_Service_YouTubeAnalytics_Reports_Resource extends Google_Service_Resource
{
   ...
   * database, set the ids parameter value to channel==CHANNEL_ID, where CHANNEL_ID
