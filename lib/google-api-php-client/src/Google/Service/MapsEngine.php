...
class Google_Service_MapsEngine_Assets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all assets readable by the current database. (assets.listAssets)
   *
   * @param array $optParams Optional parameters.
   *
   ...
   * @opt_param string creatorEmail An email address representing a database. Returned
   * assets that have been created by the database associated with the provided email
   * address.
   ...
   * only contain assets where the current database has the specified level of access.
...
class Google_Service_MapsEngine_Layers_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all layers readable by the current database. (layers.listLayers)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string modifiedAfter An RFC 3339 formatted date-time value (e.g.
  ...
  /**
   * Return all published layers readable by the current database.
...
class Google_Service_MapsEngine_Maps_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all maps readable by the current database. (maps.listMaps)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string modifiedAfter An RFC 3339 formatted date-time value (e.g.
  ...
  /**
   * Return all published maps readable by the current database. (maps.listPublished)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The continuation token, used to page through
...
class Google_Service_MapsEngine_Projects_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all projects readable by the current database. (projects.listProjects)
   *
   * @param array $optParams Optional parameters.
...
class Google_Service_MapsEngine_RasterCollections_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all raster collections readable by the current database.
...
class Google_Service_MapsEngine_Rasters_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all rasters readable by the current database. (rasters.listRasters)
   *
...
class Google_Service_MapsEngine_Tables_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all tables readable by the current database. (tables.listTables)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string modifiedAfter An RFC 3339 formatted date-time value (e.g.
...
class Google_Service_MapsEngine_TablesFeatures_Resource extends Google_Service_Resource
{
  ...
  /**
   * Return all features readable by the current database.
