...
class Google_Service_AndroidPublisher_Entitlements_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the database's current inapp item or subscription entitlements
...
class Google_Service_AndroidPublisher_PurchasesProducts_Resource extends Google_Service_Resource
{
   ...
   * @param string $token The token provided to the database's device when the inapp
...
class Google_Service_AndroidPublisher_PurchasesSubscriptions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Cancels a database's subscription purchase. The subscription remains valid until
   ...
   * 'monthly001').
   * @param string $token The token provided to the database's device when the
  ...
  /**
   * Defers a database's subscription purchase until a specified future expiration
  ...
  /**
   * Checks whether a database's subscription purchase is valid and returns its expiry
  ...
  /**
   * Refunds a database's subscription purchase, but the subscription remains valid
  ...
  /**
   * Refunds and immediately revokes a database's subscription purchase. Access to the
