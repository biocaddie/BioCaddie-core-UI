...
class Google_Service_GamesManagement_Achievements_Resource extends Google_Service_Resource
{
   ...
   * to database accounts for your developer console.
   ...
   * available to database accounts for your developer console. Only draft
...
class Google_Service_GamesManagement_Applications_Resource extends Google_Service_Resource
{
   ...
   * only available to database accounts for your developer console.
...
class Google_Service_GamesManagement_Events_Resource extends Google_Service_Resource
{
   ...
   * database accounts for your developer console. All quests that use any of these
   ...
   * available to database accounts for your developer console. Only draft events can
   ...
   * available to database accounts for your developer console. Only draft events may
...
class Google_Service_GamesManagement_Players_Resource extends Google_Service_Resource
{
   ...
   * method is only available to database accounts for your developer console.
   * (players.hide)
   *
   * @param string $applicationId The application ID from the Google Play
   * developer console.
...
class Google_Service_GamesManagement_Quests_Resource extends Google_Service_Resource
{
   ...
   * database accounts for your developer console. (quests.resetAllForAllPlayers)
   *
   * @param array $optParams Optional parameters.
   */
  public function resetAllForAllPlayers($optParams = array())
   ...
   * This method is only available to database accounts for your developer console.
   ...
   * available to database accounts for your developer console. Only draft quests may
...
class Google_Service_GamesManagement_Rooms_Resource extends Google_Service_Resource
{
   ...
   * accounts for your application. This method is only available to database accounts
...
class Google_Service_GamesManagement_Scores_Resource extends Google_Service_Resource
{
   ...
   * available to database accounts for your developer console.
   ...
   * method is only available to database accounts for your developer console. Only
...
class Google_Service_GamesManagement_TurnBasedMatches_Resource extends Google_Service_Resource
{
  ...
  /**
   * Reset all turn-based match data for a database. This method is only accessible to
