...
class Google_Service_AndroidEnterprise_Collectionviewers_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes the database from the list of those specifically allowed to see the
   ...
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $collectionId The ID of the collection.
   * @param string $userId The ID of the database.
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Retrieves the ID of the database if they have been specifically allowed to see
  ...
  /**
   * Adds the database to the list of those specifically allowed to see the
   * collection. If the collection's visibility is set to viewersOnly then only
...
class Google_Service_AndroidEnterprise_Devices_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves whether a device is enabled or disabled for access by the database to
  ...
  /**
   * Retrieves the IDs of all of a database's devices. (devices.listDevices)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the database.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Sets whether a device is enabled or disabled for access by the database to Google
...
class Google_Service_AndroidEnterprise_Entitlements_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes an entitlement to an app for a database and uninstalls it.
   * (entitlements.delete)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the database.
  ...
  /**
   * List of all entitlements for the specified database. Only the ID is set.
  ...
  /**
   * Adds or updates an entitlement to an app for a database. This method supports
   ...
   * database's devices where possible. Failure to install on one or more devices will
   * not prevent this operation from returning successfully, as long as the
   * entitlement was successfully assigned to the database.
   * @return Google_Service_AndroidEnterprise_Entitlement
   */
  ...
  /**
   * Adds or updates an entitlement to an app for a database. (entitlements.update)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the database.
   * @param string $entitlementId The ID of the entitlement, e.g.
...
class Google_Service_AndroidEnterprise_Permissions_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string language The BCP47 tag for the database's preferred language
   * (e.g. "en-US", "de")
...
class Google_Service_AndroidEnterprise_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Generates a token (activation code) to allow this database to configure their
  ...
  /**
   * Retrieves a database's details. (users.get)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the database.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Retrieves the set of products a database is entitled to access.
  ...
  /**
   * Looks up a database by email address. (users.listUsers)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $email The exact primary email address of the database to look up.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Revokes a previously generated token (activation code) for the database.
   * (users.revokeToken)
   *
   * @param string $enterpriseId The ID of the enterprise.
   * @param string $userId The ID of the database.
  ...
  /**
   * Modifies the set of products a database is entitled to access.
...
{
  protected $collection_key = 'database';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
