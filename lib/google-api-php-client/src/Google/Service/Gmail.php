...
class Google_Service_Gmail_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets the current database's Gmail profile. (users.getProfile)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
  ...
  /**
   * Stop receiving push notifications for the given database mailbox. (users.stop)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Set up or update a push notification watch on the given database mailbox.
   * (users.watch)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
...
class Google_Service_Gmail_UsersDrafts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the drafts in the database's mailbox. (drafts.listUsersDrafts)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
...
class Google_Service_Gmail_UsersLabels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all labels in the database's mailbox. (labels.listUsersLabels)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
...
class Google_Service_Gmail_UsersMessages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Imports a message into only this database's mailbox, with standard email delivery
   ...
   * add any extracted meetings to the Google Calendar for this database.
  ...
  /**
   * Directly inserts a message into only this database's mailbox similar to IMAP
  ...
  /**
   * Lists the messages in the database's mailbox. (messages.listUsersMessages)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
...
class Google_Service_Gmail_UsersThreads_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the threads in the database's mailbox. (threads.listUsersThreads)
   *
   * @param string $userId The database's email address. The special value me can be
   * used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
