...
class Google_Service_YouTube_Activities_Resource extends Google_Service_Resource
{
  ...
  /**
   * Posts a bulletin for a specific channel. (The database submitting the request
   * must be authorized to act on the channel's behalf.)
   *
   * Note: Even though an activity resource can contain information about actions
   * like a database rating a video or marking a video as a favorite, you need to use
   ...
   * events associated with the database's subscriptions and Google+ friends, or the
   * YouTube home page feed, which is customized for each database.
   ...
   * database's previous activity on YouTube does not provide enough information to
   ...
   * the authenticated database's activities.
...
class Google_Service_YouTube_Captions_Resource extends Google_Service_Resource
{
   ...
   * authorization credentials identify a YouTube CMS database who is acting on behalf
   ...
   * account that the database authenticates with must be linked to the specified
...
class Google_Service_YouTube_ChannelBanners_Resource extends Google_Service_Resource
{
   ...
   * the database authenticates with must be linked to the specified YouTube content
   * owner.
...
class Google_Service_YouTube_ChannelSections_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a channelSection for the authenticated database's channel.
   ...
   * @opt_param bool mine Set this parameter's value to true to retrieve a feed of
   * the authenticated database's channelSections.
...
class Google_Service_YouTube_Channels_Resource extends Google_Service_Resource
{
   ...
   * parameter specifies. The database must be authenticated as a CMS account linked
   ...
   * to only return channels owned by the authenticated database.
   * @opt_param string maxResults The maxResults parameter specifies the maximum
   * number of items that should be returned in the result set.
   * @opt_param string id The id parameter specifies a comma-separated list of the
   ...
   * authenticated database's channel.
   ...
   * indicates that the authenticated database is acting on behalf of the content
   ...
   * for each individual channel. The actual CMS account that the database
...
class Google_Service_YouTube_LiveBroadcasts_Resource extends Google_Service_Resource
{
   ...
   * only return broadcasts owned by the authenticated database. Set the parameter
...
class Google_Service_YouTube_LiveStreams_Resource extends Google_Service_Resource
{
   ...
   * channel.
   * @opt_param bool mine The mine parameter can be used to instruct the API to
   * only return streams owned by the authenticated database. Set the parameter value
...
class Google_Service_YouTube_Playlists_Resource extends Google_Service_Resource
{
   ...
   * example, you can retrieve all playlists that the authenticated database owns, or
   ...
   * @opt_param bool mine Set this parameter's value to true to instruct the API
   * to only return playlists owned by the authenticated database.
   * @opt_param string maxResults The maxResults parameter specifies the maximum
   * number of items that should be returned in the result set.
   * @opt_param string pageToken The pageToken parameter identifies a specific
   * page in the result set that should be returned. In an API response, the
...
class Google_Service_YouTube_Search_Resource extends Google_Service_Resource
{
   ...
   * The database must be authenticated using a CMS account linked to the specified
   ...
   * retrieve videos owned by the authenticated database. If you set this parameter to
...
class Google_Service_YouTube_Subscriptions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a subscription for the authenticated database's channel.
   ...
   * @opt_param bool mine Set this parameter's value to true to retrieve a feed of
   * the authenticated database's subscriptions.
   * @opt_param string maxResults The maxResults parameter specifies the maximum
   * number of items that should be returned in the result set.
   ...
   * a feed of the subscribers of the authenticated database.
   * @opt_param string order The order parameter specifies the method that will be
...
class Google_Service_YouTube_Videos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves the ratings that the authorized database gave to a list of specified
