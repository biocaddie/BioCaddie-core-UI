...
class Google_Service_PlusDomains_Activities_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a new activity for the authenticated database. (activities.insert)
   *
   * @param string $userId The ID of the database to create the activity on behalf of.
   * Its value should be "me", to indicate the authenticated database.
  ...
  /**
   * List all of the activities in the specified collection for a particular database.
   * (activities.listActivities)
   *
   * @param string $userId The ID of the database to get activities for. The special
   * value "me" can be used to indicate the authenticated database.
...
class Google_Service_PlusDomains_Audiences_Resource extends Google_Service_Resource
{
  ...
  /**
   * List all of the audiences to which a database can share.
   * (audiences.listAudiences)
   *
   * @param string $userId The ID of the database to get audiences for. The special
   * value "me" can be used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The continuation token, which is used to page
...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a new circle for the authenticated database. (circles.insert)
   *
   * @param string $userId The ID of the database to create the circle on behalf of.
   * The value "me" can be used to indicate the authenticated database.
  ...
  /**
   * List all of the circles for a database. (circles.listCircles)
   *
   * @param string $userId The ID of the database to get circles for. The special
   * value "me" can be used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The continuation token, which is used to page
...
class Google_Service_PlusDomains_People_Resource extends Google_Service_Resource
{
   ...
   * special value "me" can be used to indicate the authenticated database.
   * @param array $optParams Optional parameters.
   ...
   * Use "me" to indicate the authenticated database.
