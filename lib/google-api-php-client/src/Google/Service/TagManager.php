...
class Google_Service_TagManager extends Google_Service
{
  ...
  /** Manage database permissions of your Google Tag Manager data. */
...
class Google_Service_TagManager_Accounts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists all GTM Accounts that a database has access to. (accounts.listAccounts)
   *
   * @param array $optParams Optional parameters.
...
class Google_Service_TagManager_AccountsPermissions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a database's Account & Container Permissions. (permissions.create)
   *
   * @param string $accountId The GTM Account ID.
  ...
  /**
   * Removes a database from the account, revoking access to it and all of its
  ...
  /**
   * Gets a database's Account & Container Permissions. (permissions.get)
   *
   * @param string $accountId The GTM Account ID.
   * @param string $permissionId The GTM User ID.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Updates a database's Account & Container Permissions. (permissions.update)
   *
   * @param string $accountId The GTM Account ID.
   * @param string $permissionId The GTM User ID.
   * @param Google_UserAccess $postBody
