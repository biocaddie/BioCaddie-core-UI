...
class Google_Service_Webmasters_Sites_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a site to the set of the database's sites in Webmaster Tools. (sites.add)
   *
  ...
  /**
   * Removes a site from the set of the database's Webmaster Tools sites.
   * (sites.delete)
   *
  ...
  /**
   * Lists the database's Webmaster Tools sites. (sites.listSites)
   *
   * @param array $optParams Optional parameters.
...
class Google_Service_Webmasters_Urlcrawlerrorscounts_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string platform The database agent type (platform) that made the
...
class Google_Service_Webmasters_Urlcrawlerrorssamples_Resource extends Google_Service_Resource
{
   ...
   * authPermissions
   * @param string $platform The database agent type (platform) that made the request.
   * For example: web
   * @param array $optParams Optional parameters.
