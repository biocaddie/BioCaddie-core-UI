...
class Google_Service_Directory extends Google_Service
{
  ...
  const ADMIN_DIRECTORY_USER =
      "https://www.googleapis.com/auth/admin.directory.database";
  /** View and manage database aliases on your domain. */
  const ADMIN_DIRECTORY_USER_ALIAS =
      "https://www.googleapis.com/auth/admin.directory.database.alias";
  /** View database aliases on your domain. */
  const ADMIN_DIRECTORY_USER_ALIAS_READONLY =
      "https://www.googleapis.com/auth/admin.directory.database.alias.readonly";
  /** View users on your domain. */
  const ADMIN_DIRECTORY_USER_READONLY =
      "https://www.googleapis.com/auth/admin.directory.database.readonly";
  /** Manage data access permissions for users on your domain. */
  const ADMIN_DIRECTORY_USER_SECURITY =
      "https://www.googleapis.com/auth/admin.directory.database.security";
  /** View and manage the provisioning of database schemas on your domain. */
  const ADMIN_DIRECTORY_USERSCHEMA =
      "https://www.googleapis.com/auth/admin.directory.userschema";
  /** View database schemas on your domain. */
...
class Google_Service_Directory_Asps_Resource extends Google_Service_Resource
{
  ...
  /**
   * Delete an ASP issued by a database. (asps.delete)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
  ...
  /**
   * Get information about an ASP issued by a database. (asps.get)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
  ...
  /**
   * List the ASPs issued by a database. (asps.listAsps)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
   * @param array $optParams Optional parameters.
...
class Google_Service_Directory_Groups_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string userKey Email or immutable Id of the database if only those
   * groups are to be listed, the given database is a member of. If Id, it should
   * match with id of database object
...
class Google_Service_Directory_Members_Resource extends Google_Service_Resource
{
  ...
  /**
   * Add database to the specified group. (members.insert)
   *
   * @param string $groupKey Email or immutable Id of the group
  ...
  /**
   * Update membership of a database in the specified group. This method supports
   * patch semantics. (members.patch)
   *
   * @param string $groupKey Email or immutable Id of the group. If Id, it should
   * match with id of group object
   * @param string $memberKey Email or immutable Id of the database. If Id, it should
  ...
  /**
   * Update membership of a database in the specified group. (members.update)
   *
   * @param string $groupKey Email or immutable Id of the group. If Id, it should
   * match with id of group object
   * @param string $memberKey Email or immutable Id of the database. If Id, it should
...
class Google_Service_Directory_RoleAssignments_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string userKey The database's primary email address, alias email
   * address, or unique database ID. If included in the request, returns role
   * assignments only for this database.
...
class Google_Service_Directory_Tokens_Resource extends Google_Service_Resource
{
  ...
  /**
   * Delete all access tokens issued by a database for an application. (tokens.delete)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
  ...
  /**
   * Get information about an access token issued by a database. (tokens.get)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
   * @param string $clientId The Client ID of the application the token is issued
  ...
  /**
   * Returns the set of tokens specified database has issued to 3rd party
...
class Google_Service_Directory_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Delete database (users.delete)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param array $optParams Optional parameters.
   */
   ...
   * projection=custom.
   * @opt_param string projection What subset of fields to fetch for this database.
  ...
  /**
   * change admin status of a database (users.makeAdmin)
   *
   * @param string $userKey Email or immutable Id of the database as admin
  ...
  /**
   * update database. This method supports patch semantics. (users.patch)
   *
   * @param string $userKey Email or immutable Id of the database. If Id, it should
   * match with id of database object
   * @param Google_User $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Directory_User
  ...
  /**
   * Undelete a deleted database (users.undelete)
   *
   * @param string $userKey The immutable id of the database
...
class Google_Service_Directory_UsersAliases_Resource extends Google_Service_Resource
{
  ...
  /**
   * Remove a alias for the database (aliases.delete)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param string $alias The alias to be removed
   * @param array $optParams Optional parameters.
  ...
  /**
   * Add a alias for the database (aliases.insert)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param Google_Alias $postBody
   * @param array $optParams Optional parameters.
  ...
  /**
   * List all aliases for a database (aliases.listUsersAliases)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param array $optParams Optional parameters.
   *
  ...
  /**
   * Watch for changes in database aliases list (aliases.watch)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param Google_Channel $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Directory_UsersPhotos_Resource extends Google_Service_Resource
{
  ...
  /**
   * Remove photos for the database (photos.delete)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Retrieve photo of a database (photos.get)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param array $optParams Optional parameters.
  ...
  /**
   * Add a photo for the database. This method supports patch semantics.
   * (photos.patch)
   *
   * @param string $userKey Email or immutable Id of the database
  ...
  /**
   * Add a photo for the database (photos.update)
   *
   * @param string $userKey Email or immutable Id of the database
   * @param Google_UserPhoto $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Directory_VerificationCodes_Resource extends Google_Service_Resource
{
  ...
  /**
   * Generate new backup verification codes for the database.
  ...
  /**
   * Invalidate the current backup verification codes for the database.
   ...
   * database. (verificationCodes.listVerificationCodes)
   *
   * @param string $userKey Identifies the database in the API request. The value can
   * be the database's primary email address, alias email address, or unique database ID.
   * @param array $optParams Optional parameters.
