...
class Google_Service_Plus_Moments_Resource extends Google_Service_Resource
{
  ...
  /**
   * Record a moment representing a database's action such as making a purchase or
   * commenting on a blog. (moments.insert)
   *
   * @param string $userId The ID of the database to record actions for. The only
   * valid values are "me" and the ID of the authenticated database.
  ...
  /**
   * List all of the moments for a particular database. (moments.listMoments)
   *
   * @param string $userId The ID of the database to get moments for. The special
   * value "me" can be used to indicate the authenticated database.
