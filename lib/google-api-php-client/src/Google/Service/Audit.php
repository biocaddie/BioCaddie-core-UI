 ...
 *
 * <p>
 * Lets you access database activities in your enterprise made through various
 * applications.</p>
 *
 * <p>
...
class Google_Service_Audit_Activities_Resource extends Google_Service_Resource
{
   ...
   *
   * @opt_param string actorEmail Email address of the database who performed the
   * action.
   * @opt_param string actorApplicationId Application ID of the application which
   * interacted on behalf of the database while performing the event.
