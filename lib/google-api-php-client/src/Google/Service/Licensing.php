  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this->licenseAssignments = new Google_Service_Licensing_LicenseAssignments_Resource(
        ...
        array(
          'methods' => array(
            'delete' => array(
              'path' => '{productId}/sku/{skuId}/database/{userId}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'productId' => array(
                  'location' => 'path',
              ...
              'path' => '{productId}/sku/{skuId}/database',
              'httpMethod' => 'POST',
              'parameters' => array(
                'productId' => array(
                  'location' => 'path',
...
class Google_Service_Licensing_LicenseAssignments_Resource extends Google_Service_Resource
{
   ...
   * @param string $userId email id or unique Id of the database
  ...
  /**
   * Get license assignment of a particular product and sku for a database
