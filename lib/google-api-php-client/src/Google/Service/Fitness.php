...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource
{
   ...
   * this database. The data stream ID field can be omitted and will be generated by
   ...
   * me to indicate the authenticated database. Only me is supported at this time.
   ...
   * scopes provided. The list is not exhaustive: the database may have private data
   ...
   * indicate the authenticated database. Only me is supported at this time.
   * @param array $optParams Optional parameters.
   *
