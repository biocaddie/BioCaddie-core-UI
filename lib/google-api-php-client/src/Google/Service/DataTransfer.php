 ...
 *
 * <p>
 * Admin Data Transfer API lets you transfer database data from one database to another.</p>
 *
 * <p>
...
class Google_Service_DataTransfer_Transfers_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists the transfers for a customer by source database, destination database, or
   ...
   * 100.
   * @opt_param string newOwnerUserId Destination database's profile ID.
   * @opt_param string oldOwnerUserId Source database's profile ID.
