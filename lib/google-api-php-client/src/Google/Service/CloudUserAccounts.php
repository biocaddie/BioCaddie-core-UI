...
class Google_Service_CloudUserAccounts_Linux_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns a list of authorized public keys for a specific database account.
   * (linux.getAuthorizedKeysView)
   *
   * @param string $project Project ID for this request.
   * @param string $zone Name of the zone for this request.
   * @param string $user The database account for which you want to get a list of
   * authorized public keys.
   * @param string $instance The fully-qualified URL of the virtual machine
   * requesting the view.
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool login Whether the view was requested as part of a database-
   * initiated login.
  ...
  /**
   * Retrieves a list of database accounts for an instance within a specific project.
