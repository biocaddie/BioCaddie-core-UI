...
class Google_Service_Tasks_Tasklists_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes the authenticated database's specified task list. (tasklists.delete)
   *
  ...
  /**
   * Returns the authenticated database's specified task list. (tasklists.get)
   *
   * @param string $tasklist Task list identifier.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Creates a new task list and adds it to the authenticated database's task lists.
   * (tasklists.insert)
   *
  ...
  /**
   * Returns all the authenticated database's task lists. (tasklists.listTasklists)
   *
   * @param array $optParams Optional parameters.
   *
  ...
  /**
   * Updates the authenticated database's specified task list. This method supports
  ...
  /**
   * Updates the authenticated database's specified task list. (tasklists.update)
   *
   * @param string $tasklist Task list identifier.
   * @param Google_TaskList $postBody
   * @param array $optParams Optional parameters.
