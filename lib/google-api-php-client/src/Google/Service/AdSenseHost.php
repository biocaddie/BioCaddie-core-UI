...
class Google_Service_AdSenseHost_Associationsessions_Resource extends Google_Service_Resource
{
   ...
   * database. (associationsessions.start)
   *
   * @param string $productCode Products to associate with the database.
   * @param string $websiteUrl The URL of the database's hosted website.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string websiteLocale The locale of the database's hosted website.
   * @opt_param string userLocale The preferred locale of the database.
