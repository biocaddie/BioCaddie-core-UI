 ...
 * <a href="https://cloud.google.com/compute/docs/access/database-accounts/api/latest/" target="_blank">Documentation</a>
 * </p>
 *
 * @author Google, Inc.
 */
  ...
  public function __construct(Google_Client $client)
  {
        ...
        array(
          'methods' => array(
            'getAuthorizedKeysView' => array(
              'path' => '{project}/zones/{zone}/authorizedKeysView/{database}',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
    ...
    $this->users = new Google_Service_Computeaccounts_Users_Resource(
        ...
        array(
          'methods' => array(
            'addPublicKey' => array(
              'path' => '{project}/global/users/{database}/addPublicKey',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/users/{database}',
              'httpMethod' => 'DELETE',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
              ...
              'path' => '{project}/global/users/{database}/removePublicKey',
              'httpMethod' => 'POST',
              'parameters' => array(
                'project' => array(
                  'location' => 'path',
...
class Google_Service_Computeaccounts_Linux_Resource extends Google_Service_Resource
{
  ...
  /**
   * Returns the AuthorizedKeysView of the specified database.
  ...
  {
    $params = array('project' => $project, 'zone' => $zone, 'database' => $user, 'instance' => $instance);
    $params = array_merge($params, $optParams);
   ...
   * @opt_param string filter Optional. Filter expression for filtering listed
   * resources.
   * @opt_param string database If provided, the database whose login is triggering an
...
class Google_Service_Computeaccounts_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a public key to the specified database using the data included in the
   * request. (users.addPublicKey)
   *
   * @param string $project Project ID for this request.
   * @param string $user Name of the database for this request.
  ...
  {
    $params = array('project' => $project, 'database' => $user, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('addPublicKey', array($params), "Google_Service_Computeaccounts_Operation");
  }

  /**
   * Deletes the specified database resource. (users.delete)
   *
   * @param string $project Project ID for this request.
   * @param string $user Name of the database resource to delete.
   * @param array $optParams Optional parameters.
   * @return Google_Service_Computeaccounts_Operation
   */
  public function delete($project, $user, $optParams = array())
  {
    $params = array('project' => $project, 'database' => $user);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_Computeaccounts_Operation");
  }

  /**
   * Returns the specified database resource. (users.get)
   *
   * @param string $project Project ID for this request.
   * @param string $user Name of the database resource to return.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Creates a database resource in the specified project using the data included in
  ...
  /**
   * Removes the specified public key from the database. (users.removePublicKey)
   *
   * @param string $project Project ID for this request.
   * @param string $user Name of the database for this request.
  ...
  {
    $params = array('project' => $project, 'database' => $user, 'fingerprint' => $fingerprint);
    $params = array_merge($params, $optParams);
