...
class Google_Service_Cloudbilling_BillingAccounts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets information about a billing account. The current authenticated database must
  ...
  /**
   * Lists the billing accounts that the current authenticated database
...
class Google_Service_Cloudbilling_BillingAccountsProjects_Resource extends Google_Service_Resource
{
   ...
   * authenticated database must be an [owner of the billing
   * account](https://support.google.com/cloud/answer/4430947).
...
class Google_Service_Cloudbilling_Projects_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets the billing information for a project. The current authenticated database
   ...
   * account was assigned to the project. The current authenticated database must have
   ...
   * billed to the previously associated account. The current authenticated database
