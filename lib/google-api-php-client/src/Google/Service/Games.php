...
class Google_Service_Games_Applications_Resource extends Google_Service_Resource
{
  ...
  /**
   * Indicate that the the currently authenticated database is playing your
...
class Google_Service_Games_Events_Resource extends Google_Service_Resource
{
   ...
   * the currently authenticated database. (events.listByPlayer)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param string pageToken The token returned by the previous request.
   ...
   * the currently authenticated database of this application. (events.record)
   *
...
class Google_Service_Games_Players_Resource extends Google_Service_Resource
{
   ...
   * the currently authenticated database, set playerId to me. (players.get)
   *
   * @param string $playerId A player ID. A value of me may be used in place of
   * the authenticated player's ID.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Get the collection of players for the currently authenticated database.
   * (players.listPlayers)
   *
...
class Google_Service_Games_Pushtokens_Resource extends Google_Service_Resource
{
  ...
  /**
   * Removes a push token for the current database and application. Removing a non-
  ...
  /**
   * Registers a push token for the current database and application.
   * (pushtokens.update)
   *
...
class Google_Service_Games_QuestMilestones_Resource extends Google_Service_Resource
{
   ...
   * database. (questMilestones.claim)
   *
...
class Google_Service_Games_Quests_Resource extends Google_Service_Resource
{
  ...
  /**
   * Indicates that the currently authorized database will participate in the quest.
   * (quests.accept)
   *
   * @param string $questId The ID of the quest.
   * @param array $optParams Optional parameters.
