...
class Google_Service_Coordinate_Team_Resource extends Google_Service_Resource
{
  ...
  /**
   * Retrieves a list of teams for a database. (team.listTeam)
   *
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool admin Whether to include teams for which the database has the
   * Admin role.
   * @opt_param bool worker Whether to include teams for which the database has the
   * Worker role.
   * @opt_param bool dispatcher Whether to include teams for which the database has
   * the Dispatcher role.
