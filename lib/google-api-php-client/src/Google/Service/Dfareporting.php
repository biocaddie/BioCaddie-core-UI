...
class Google_Service_Dfareporting_AccountUserProfiles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one account database profile by ID. (accountUserProfiles.get)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Inserts a new account database profile. (accountUserProfiles.insert)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Retrieves a list of account database profiles, possibly filtered.
   ...
   * email. Wildcards (*) are allowed. For example, "database profile*2015" will
   * return objects with names like "database profile June 2015", "database profile April
   * 2015", or simply "database profile 2015". Most of the searches also add wildcards
   * implicitly at the start and the end of the search string. For example, a
   * search string of "database profile" will match objects with name "my database
   * profile", "database profile 2015", or simply "database profile".
   * @opt_param string subaccountId Select only database profiles with the specified
   * subaccount ID.
   * @opt_param string sortField Field by which to sort the list.
   * @opt_param string ids Select only database profiles with these IDs.
   * @opt_param int maxResults Maximum number of results to return.
   * @opt_param string pageToken Value of the nextPageToken from the previous
   * result page.
   * @opt_param string userRoleId Select only database profiles with the specified
   * database role ID.
   * @opt_param string sortOrder Order of sorted results, default is ASCENDING.
   * @opt_param bool active Select only active database profiles.
  ...
  /**
   * Updates an existing account database profile. This method supports patch
  ...
  /**
   * Updates an existing account database profile. (accountUserProfiles.update)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param Google_AccountUserProfile $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Dfareporting_ChangeLogs_Resource extends Google_Service_Resource
{
   ...
   * @opt_param string searchString Select only change logs whose object ID, database
   ...
   * other words, the year, month, day, the letter T, the hour (24-hour clock
   * system), minute, second, and then the time zone offset.
   * @opt_param string userProfileIds Select only change logs with these database
   * profile IDs.
...
class Google_Service_Dfareporting_DimensionValues_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $profileId The DFA database profile ID.
...
class Google_Service_Dfareporting_Files_Resource extends Google_Service_Resource
{
  ...
  /**
   * Lists files for a database profile. (files.listFiles)
   *
...
class Google_Service_Dfareporting_ReportsCompatibleFields_Resource extends Google_Service_Resource
{
   ...
   * report and database permissions. (compatibleFields.query)
   *
   * @param string $profileId The DFA database profile ID.
   * @param Google_Report $postBody
   * @param array $optParams Optional parameters.
...
class Google_Service_Dfareporting_UserProfiles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one database profile by ID. (userProfiles.get)
   *
   * @param string $profileId The database profile ID.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Retrieves list of database profiles for a database. (userProfiles.listUserProfiles)
   *
   * @param array $optParams Optional parameters.
...
class Google_Service_Dfareporting_UserRolePermissionGroups_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one database role permission group by ID. (userRolePermissionGroups.get)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Gets a list of all supported database role permission groups.
...
class Google_Service_Dfareporting_UserRolePermissions_Resource extends Google_Service_Resource
{
  ...
  /**
   * Gets one database role permission by ID. (userRolePermissions.get)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Gets a list of database role permissions, possibly filtered.
   * (userRolePermissions.listUserRolePermissions)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string ids Select only database role permissions with these IDs.
...
class Google_Service_Dfareporting_UserRoles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes an existing database role. (userRoles.delete)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Gets one database role by ID. (userRoles.get)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param string $id User role ID.
   * @param array $optParams Optional parameters.
  ...
  /**
   * Inserts a new database role. (userRoles.insert)
   *
   * @param string $profileId User profile ID associated with this request.
  ...
  /**
   * Retrieves a list of database roles, possibly filtered. (userRoles.listUserRoles)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param array $optParams Optional parameters.
   *
   ...
   * simply "userrole".
   * @opt_param string subaccountId Select only database roles that belong to this
   * subaccount.
   * @opt_param string sortField Field by which to sort the list.
   * @opt_param string ids Select only database roles with the specified IDs.
   * @opt_param int maxResults Maximum number of results to return.
   * @opt_param string pageToken Value of the nextPageToken from the previous
   * result page.
   * @opt_param string sortOrder Order of sorted results, default is ASCENDING.
   * @opt_param bool accountUserRoleOnly Select only account level database roles not
  ...
  /**
   * Updates an existing database role. This method supports patch semantics.
   * (userRoles.patch)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param string $id User role ID.
  ...
  /**
   * Updates an existing database role. (userRoles.update)
   *
   * @param string $profileId User profile ID associated with this request.
   * @param Google_UserRole $postBody
   * @param array $optParams Optional parameters.
