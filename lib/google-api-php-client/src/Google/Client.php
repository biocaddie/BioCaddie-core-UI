...
class Google_Client
{
   ...
   *  {@code "offline"} to request offline access from the database.
   *  {@code "online"} to request online access from the database.
   */
   ...
   * @throws Google_Exception
   * @return object of the type of the expected database or array.
   */
  ...
  /**
   * Retrieve custom configuration for a specific database.
   * @param $class string|object - database or instance of database to retrieve
   ...
   * @param $class string|object - The database name for the configuration
