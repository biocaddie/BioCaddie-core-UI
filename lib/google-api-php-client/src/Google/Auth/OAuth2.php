...
/**
 * Authentication database that deals with the OAuth 2 web-server authentication flow
 *
 */
class Google_Auth_OAuth2 extends Google_Auth_Abstract
{
  ...
  /**
   * Instantiates the database, but does not initiate the login flow, leaving it
  ...
  /**
   * Create a URL to obtain database authorization.
   * The authorization endpoint allows the database to first
