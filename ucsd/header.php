      ...
      <div class="header clearfix">
        <nav>
          <ul class="nav nav-pills pull-right">
            ...
            <li role="presentation" class="active"><a href="https://biocaddie.org/about" target='_blank'>About</a></li>
        ...
        <!--<h3 class="text-muted">BioCADDIE</h3>-->
         <a href="https://biocaddie.org"><img src="../images/biocaddie-logo.png" alt="Mountain View" style="width:148px;height:78px;"></a>
      </div>
