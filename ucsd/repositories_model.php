...
class PDB_data extends repository{
	...
	public $search_fields = ['_all'];//['dataItem.ID','dataItem.title','dataItem.keywords','dataItem.description','citation.title'];//['dataResource.freeText'];//
	public $facets_fields = ['citation.journal','citation.year',"dataItem.keywords"];

  public $facets_show_name = ['citation.journal'=>'Journal',
                              'citation.year'=>'Publication Year',
                              "dataItem.keywords"=>'Keywords'];

	public $index = 'biocaddie';
	public $type = 'pdb';
